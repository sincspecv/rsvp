...
account.controller('guestListCtrl', function($scope, $http) {

    $scope.formData = {}; //Object to collect form data

    $scope.submitForm = function(isValid, $eventCode) {
...
account.controller('modalController', function($scope, $log, $uibModal, $window){
